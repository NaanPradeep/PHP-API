    ...
    try {
        ...
        if($user->emailExists() && $token_updated){
            ...
            $body = _("<p>Here is your verification link. Verification link stays valid for <em>24 hours</em>. 
                    <a href='http://localhost:3011/metronic8/react/demo1/verify-user?token={$otp}'>
                    Click Here
                    </a></p>");
            ...
            try {
                ...
                echo json_encode(array(
                    "message" => _gettext("Verification email has been successfully sent to your email."),
                    "success" => true
                ));
                ...
                echo json_encode(array(
                    "message" => _gettext("Unable to send email, please check your email address"),
                    "success" => false
                ));
            }
        }
        // message if unable to find email
            ...
            echo json_encode(array(
                "message" => _gettext("Email does not exist in our record"),
                "success" => false
            ));
        }
