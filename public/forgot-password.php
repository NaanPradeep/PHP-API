...
if($email_exist) {
    ...
    $subject = _gettext("Password Request Link");
    ...
    try {
        ...
        echo json_encode(array(
            "message" => _gettext("Password reset link has been sent to your email."),
            "sent_email" => true
            ));
        ...
        echo json_encode(array(
            "message" => _gettext("Couldn't send an email. Please check your email address"),
            "sent_email" => false
            ));
    }
    ...
    echo json_encode(array(
        "message" => _gettext("Your email address is not registered in our record."),
        "sent_email" => false
    ));
}
